...
def ipPuerto():
    ...
    if len(sys.argv) == 3:
        ...
        print('Para iniciar el programa debe ingresar de la siguiente forma: $python3 subscribers.py ipElastica(AWS) puerto')
        print('$python3 subscribers.py 54.161.183.209 5672\n')
